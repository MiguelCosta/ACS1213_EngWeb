...
class OrcamentoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Orcamento'];
			if($model->save())
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('indexByUser?UserID='.Yii::app()->user->id));
	}
	...
	{
		$dataProvider=new CActiveDataProvider('Orcamento');
	...
	{
		$model=new Orcamento('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Orcamento']))
			$model->attributes=$_GET['Orcamento'];
	...
	{
		$model=Orcamento::model()->findByPk($id);
		if($model===null)
